...
# ==============================================================================
# CSS "CHIẾN THUẬT MỚI" (TARGET LINK & FIX OVERLAP)
# ==============================================================================
st.markdown("""
    <style>
        /* 1. DIỆT NÚT ĐỎ (HOSTED WITH STREAMLIT) */
        /* Cách mới: Tìm thẻ <a> chứa link trỏ về streamlit cloud và ẩn nó */
        a[href*="streamlit.io/cloud"] {
            display: none !important;
            visibility: hidden !important;
            height: 0 !important;
        }
        /* Phòng hờ: Ẩn luôn container chứa nó (thường có class viewerBadge...) */
        div[class*="viewerBadge"] {
            display: none !important;
        }

        /* 2. ẨN CÁC THÀNH PHẦN THỪA KHÁC */
        ...
        /* 3. TỐI ƯU GIAO DIỆN MOBILE (QUAN TRỌNG) */
        /* Đẩy nội dung chính lên sát top (vì đã ẩn header) */
        .block-container {
            padding-top: 1rem !important;
            padding-bottom: 5rem !important; /* Chừa chỗ trống lớn ở dưới để scroll thoải mái */
        }

        /* 4. COPYRIGHT (KHÔNG DÙNG FIXED NỮA - ĐỂ TRÁNH ĐÈ NÚT) */
        .custom-footer {
            width: 100%;
            text-align: center;
            color: #888;
            ...
            /* Đảm bảo nó nằm im dưới cùng như một nội dung bình thường */
            position: relative; 
            display: block;
        }

        /* 5. FIX DARK MODE CHO INPUT */
        input {
...
# CSS Patch cho Dark Mode (nếu cần)
...
# --- CUSTOM FOOTER (ĐÃ FIX: KHÔNG CÒN ĐÈ NÚT) ---
